...
// about dtt text fadding...
var clutter = "";

document
  .querySelector("#about-dtt-text > h1")
  .textContent.split("")
  .forEach(function (dets) {
    clutter += `<span>${dets}</span>`;
    document.querySelector("#about-dtt-text > h1").innerHTML = clutter;
  });

gsap.to("#about-dtt-text > h1 > span", {
  stagger: 0.2,
  color: "#fff",
  scrollTrigger: {
    trigger: "#about-dtt-text > h1 > span",
    scroller: "#main",
    start: "top bottom",
    end: "bottom top",
    scrub: 0.5,
...
// 3d model animation
function canvas() {
  const canvas = document.querySelector("#model-sec > canvas");
...
// connect-dtt text fadding ...
var clutter = "";

document
  .querySelector("#connect-dtt-text > h1")
  .textContent.split("")
  .forEach(function (dets) {
    clutter += `<span>${dets}</span>`;
    document.querySelector("#connect-dtt-text > h1").innerHTML = clutter;
  });

gsap.to("#connect-dtt-text > h1 > span", {
  stagger: 0.2,
  color: "#fff",
  scrollTrigger: {
    trigger: "#connect-dtt-text > h1 > span",
    scroller: "#main",
    start: "top bottom",
    end: "bottom top",
    scrub: 0.5,
...
//3d building-sec
function canvas1() {
  const canvas = document.querySelector("#building-sec > canvas");
  const context = canvas.getContext("2d");
...
// increase-dtt text fadding ...
var clutter = "";

document
  .querySelector("#increase-dtt-text > h1")
  .textContent.split("")
  .forEach(function (dets) {
    clutter += `<span>${dets}</span>`;
    document.querySelector("#increase-dtt-text > h1").innerHTML = clutter;
  });

gsap.to("#increase-dtt-text > h1 > span", {
  stagger: 0.2,
  color: "#fff",
  scrollTrigger: {
    trigger: "#increase-dtt-text > h1 > span",
    scroller: "#main",
    start: "top bottom",
    end: "bottom top",
    scrub: 0.5,
...
// loading-sec...
function canvas2() {
  const canvas = document.querySelector("#loading-sec > canvas");
  const context = canvas.getContext("2d");
...
gsap.to("#loading-inner-circle", {
  backgroundColor: "#0a3bce88",
  duration: 8,
  delay: 10,
  scrollTrigger: {
    trigger: "#loading-inner-circle",
    scroller: "#main",
    start: "center center",
    end: "bottom top",
    scrub: 1,
